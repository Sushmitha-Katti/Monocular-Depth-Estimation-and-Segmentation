...
<br/>
 ...
 # **Data Collection and Preprocessing**:mag_right:
  ...
  [For more info can refer this link](https://github.com/Sushmitha-Katti/EVA-4/tree/master/Session14/?target=_blank). 
 ...
 2. **Data transformation and data loading**
       ...
       * **Bringing it to dataset format** [Refer here for code](https://github.com/Sushmitha-Katti/PyTNet/blob/master/Dataset/MaskDepth.py) 
...
# **Model Evaluation**:test_tube:
 ...
 # **Implementation 👨‍💻**
   ...
   3. **Combined model**  [For more detailed explanation refer here](https://github.com/Sushmitha-Katti/Monocular-Depth-Estimation-and-Segmentation/tree/master/Both_Mask_n_Depth)
      ...
      <img src = "https://github.com/Sushmitha-Katti/Monocular-Depth-Estimation-and-Segmentation/blob/master/Assets/Combined-Model.jpg"></p>
